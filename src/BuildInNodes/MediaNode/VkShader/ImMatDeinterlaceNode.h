...
{
    BP_NODE_WITH_NAME(DeinterlaceNode, "Deinterlace", "CodeWin", VERSION_BLUEPRINT, VERSION_BLUEPRINT_API, NodeType::Internal, NodeStyle::Default, "Filter#Video#Enhance")
    DeinterlaceNode(BP* blueprint): Node(blueprint) { m_Name = "DeInterlace"; }
    ~DeinterlaceNode()
    {
