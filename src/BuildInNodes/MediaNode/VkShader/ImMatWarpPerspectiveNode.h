...
{
    BP_NODE_WITH_NAME(MatWarpPerspectiveNode, "Mat Warp Perspective", "CodeWin", VERSION_BLUEPRINT, VERSION_BLUEPRINT_API, NodeType::Internal, NodeStyle::Default, "Media")
